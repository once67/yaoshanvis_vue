<template>
  <div class="home-container">
    ...
    <header class="top-nav glassmorphism">
      <div class="logo-area">
        <img src="/logos/seal-logo.png" alt="药膳可视化系统" class="logo">
      ...
      <div class="feature-cards">
        ...
        >
          ...
          <div class="card-icon-area" :class="{ 'active': activeCardIndex === index }">
            ...
            <div class="icon-bg-pattern" :style="{ backgroundImage: `url(/backgrounds/pattern-${index+1}.svg)` }"></div>
          </div>
...
.ink-texture {
  ...
  width: 100%;
  height: 100%;
  background: url('/backgrounds/ink-texture.jpg') no-repeat center center;
...
.paper-texture {
  ...
  width: 100%;
  height: 100%;
  background: url('/backgrounds/paper-texture.jpg') repeat;
  opacity: 0.08;
...
.taichi-pattern {
  ...
  width: 1000px;
  height: 1000px;
  background: url('/backgrounds/taichi-pattern.svg') no-repeat center center;
...
.recipe-icon {
  background-image: url('/icons/recipe.svg');
}

.season-icon {
  background-image: url('/icons/season.svg');
}
